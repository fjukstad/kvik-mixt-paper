...
% LAB: Disse beksrivelsene er greie for denne konferansen, selv om de
% antageligvis ville vært for detaljert til ett vanlig CS paper. 
% LAB: Men jeg savner tall slik det er er i MIxT beskrivelsen. Disse vil gi en
% ide om hvor komplisert og regneintensiv operasjonene er, hvor mye data som
% sendes, etc. Merk! jeg ser det er noen tall lenger ned om nodes, edges, mm.
